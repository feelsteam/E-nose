...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define _HTCFG_VR_GPIOX                         C               // PC2 / ADC_CH2
  #define _HTCFG_VR_GPION                         2
  #define _HTCFG_VR_ADC_CHN                       2
  #define _HTCFG_VR2_GPIOX                        C               // PC3 / ADC_CH3
  #define _HTCFG_VR2_GPION                        3
  #define _HTCFG_VR2_ADC_CHN                      3
#endif
...
#ifdef _HTCFG_VR2_GPIOX
#define HTCFG_VR2_GPIO_ID                         STRCAT2(GPIO_P,         _HTCFG_VR2_GPIOX)
#define HTCFG_VR2_AFIO_PIN                        STRCAT2(AFIO_PIN_,      _HTCFG_VR2_GPION)
#define HTCFG_VR2_ADC_CH                          STRCAT2(ADC_CH_,        _HTCFG_VR2_ADC_CHN)
#define HTCFG_ADC_TWO_CH                          (1)
#else
#define HTCFG_ADC_TWO_CH                          (0)
#endif
